  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        hid: "keywords",
        name: "keywords",
        content: "красная поляна отели со скидками, отели +с трансфером +на красную поляну, отели красная поляна +с детьми, забронировать отель +на красной поляне, трансфер роза хутор"
      },

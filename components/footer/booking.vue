<template>
  <v-card class="footer-booking d-flex flex-column justify-center" color="#454850" elevation="0">
    ...
    <v-card-actions class="d-flex justify-center pa-0 mt-2">
      <v-btn class="rounded-lg" title="vk" width="30px" height="30px" min-width="0" min-height="0"
             elevation="0" color="#2787f5" target="_blank" href="https://vk.com/ultimaclub">
      ...
      <v-btn class="rounded-lg" title="telegram" width="30px" height="30px" min-width="0" min-height="0"
             elevation="0" color="#24A2DF" target="_blank" href="https://t.me/+79385555552">

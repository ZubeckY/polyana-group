        ...
        <v-dialog v-model="dialog" ref="dialog" max-width="360px"
          ...
          <v-card elevation="0">
            <v-card-actions class="pa-0">
              <v-spacer/>
              <v-btn @click="dialog = false" color="error" title="Закрыть" text
...
.feedbackForm-inputGroup-input svg {
  margin: 0 12px;
}
